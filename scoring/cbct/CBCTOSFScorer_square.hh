...
#ifndef CBCTOSFScorer_square_hh
#define CBCTOSFScorer_square_hh
...
class CBCTOSFScorer_square : public TsVBinnedScorer
{
public:
    CBCTOSFScorer_square(TsParameterManager *pM, TsMaterialManager *mM, TsGeometryManager *gM, TsScoringManager *scM, TsExtensionManager *eM,
                  G4String scorerName, G4String quantity, G4String outFileName, G4bool isSubScorer);

    virtual ~CBCTOSFScorer_square();
