...
public:
    ...
    void GetDigitizers(void);

protected:
    G4bool    fIncludeSourceOrigin;
    G4int     fNbDigitizers;
    G4String* fDigitizerList;
    ...
    G4double fMinEnergy;
    G4double fMaxEnergy;
    G4double fPileupTimingWindow;
    G4double fSigmoidalThreshold;
    G4double fSigmoidalAlpha;
    G4double fSigmoidalPercent;
...
protected:
    ...
    void                CoincidenceDetection(std::vector<Pulse>* singles,
                       ...
                       std::vector<Coincidence>& coincidencesRandoms, G4bool onlyDoStart, G4bool garbageCollect);
};
